...
class FamilyFragment : Fragment(), SearchView.OnQueryTextListener  {
    ...
    override fun onCreateView(
        ...
        mContactsViewModel.getFamilyContacts.observe(viewLifecycleOwner) { data ->
    ...
    private fun searchThroughDatabase(query: String) {
        ...
        mContactsViewModel.searchFamily(searchQuery).observeOnce(viewLifecycleOwner) { listOfSearch ->
            listOfSearch.let {
                adapter.setData(it)
            }
        }
