package com.example.mycontactsapp.ui.list
...
import com.example.mycontactsapp.databinding.FragmentListBinding
...
class ListFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onCreateView(
        ...
        mContactsViewModel.getAllData.observe(viewLifecycleOwner) { data ->
    ...
    private fun searchThroughDatabase(query: String) {
        ...
        mContactsViewModel.searchDatabase(searchQuery).observeOnce(viewLifecycleOwner) { listOfSearch ->
            listOfSearch.let {
                adapter.setData(it)
            }
        }
