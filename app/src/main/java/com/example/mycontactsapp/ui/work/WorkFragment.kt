package com.example.mycontactsapp.ui.work
...
class WorkFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onCreateView(
        ...
        mContactsViewModel.getWorkContacts.observe(viewLifecycleOwner) { data ->
    ...
    private fun searchThroughDatabase(query: String) {
        ...
        mContactsViewModel.searchWork(searchQuery).observeOnce(viewLifecycleOwner) { listOfSearch ->
            listOfSearch.let {
                adapter.setData(it)
            }
        }
