package com.example.mycontactsapp.ui.other
...
import com.example.mycontactsapp.databinding.FragmentOtherBinding
import com.example.mycontactsapp.databinding.FragmentWorkBinding
...
class OtherFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onCreateView(
        ...
        mContactsViewModel.getOtherContacts.observe(viewLifecycleOwner) { data ->
    ...
    private fun searchThroughDatabase(query: String) {
        ...
        mContactsViewModel.searchOther(searchQuery).observeOnce(viewLifecycleOwner) { listOfSearch ->
            listOfSearch.let {
                adapter.setData(it)
            }
        }
